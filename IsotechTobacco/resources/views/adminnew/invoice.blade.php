...
<head>
    ...
    {{-- <link rel="stylesheet" href="/IsotechTobacco/public/css-new/user/css/main.css"> --}}
    {{-- <link rel="stylesheet" href="{{ public.css-new.user.css.main }}"> --}}
</head>
<style>
    @charset "UTF-8";
/*!
...
<body>
    ...
    <!-- Vendor JS-->
    {{-- <script src="/IsotechTobacco/public/js-new/user/vendor/modernizr-3.6.0.min.js"></script>
    <script src="/IsotechTobacco/public/js-new/user/vendor/jquery-3.6.0.min.js"></script>
    <script src="/IsotechTobacco/public/js-new/user/vendor/jquery-migrate-3.3.0.min.js"></script>
    <script src="/IsotechTobacco/public/js-new/user/vendor/bootstrap.bundle.min.js"></script>
    <script src="/IsotechTobacco/public/js-new/user/plugins/slick.js"></script>
    <script src="/IsotechTobacco/public/js-new/user/plugins/jquery.syotimer.min.js"></script>
    <script src="/IsotechTobacco/public/js-new/user/plugins/wow.js"></script>
    <script src="/IsotechTobacco/public/js-new/user/plugins/jquery-ui.js"></script>
    <script src="/IsotechTobacco/public/js-new/user/plugins/perfect-scrollbar.js"></script>
    <script src="/IsotechTobacco/public/js-new/user/plugins/magnific-popup.js"></script>
    <script src="/IsotechTobacco/public/js-new/user/plugins/select2.min.js"></script>
    <script src="/IsotechTobacco/public/js-new/user/plugins/waypoints.js"></script>
    <script src="/IsotechTobacco/public/js-new/user/plugins/counterup.js"></script>
    <script src="/IsotechTobacco/public/js-new/user/plugins/jquery.countdown.min.js"></script>
    <script src="/IsotechTobacco/public/js-new/user/plugins/images-loaded.js"></script>
    <script src="/IsotechTobacco/public/js-new/user/plugins/isotope.js"></script>
    <script src="/IsotechTobacco/public/js-new/user/plugins/scrollup.js"></script>
    <script src="/IsotechTobacco/public/js-new/user/plugins/jquery.vticker-min.js"></script>
    <script src="/IsotechTobacco/public/js-new/user/plugins/jquery.theia.sticky.js"></script>
    <script src="/IsotechTobacco/public/js-new/user/plugins/jquery.elevatezoom.js"></script> --}}
    <!-- Template  JS -->
    {{-- <script src="/IsotechTobacco/public/js-new/user/main.js"></script>
    <script src="/IsotechTobacco/public/js-new/user/shop.js"></script> --}}
</body>
