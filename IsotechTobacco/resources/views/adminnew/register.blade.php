...
@section('meta-title')
    Gondrong Tobacco | Admin Register
@endsection

@section('main-content')
<div class="card mx-auto card-login">
    <div class="card-body">
        <h4 class="card-title mb-4">Register Admin</h4>
        ...
        <p class="text-center mb-2">Already have an account? <a href="/admin/login">Sign in now</a></p>
        @if($errors->any())
            <div class="mb-3">
                <p class="float-center font-sm text-danger ">{{$errors->first()}}</p>
            </div>
        @endif
    </div>
</div>
