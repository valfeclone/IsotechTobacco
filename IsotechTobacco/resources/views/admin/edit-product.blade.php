        ...
        <div class="card-body">
            <form method="POST" action="/admin/edit-product/{id}" enctype='multipart/form-data'>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" placeholder="Type here" class="form-control" id="description" name="description" value="{{ $product->description }}">
                    {{-- <textarea id="description" name="description" placeholder="Type here" class="form-control" rows="4" value="{{ $product->description }}"></textarea> --}}
                </div>
                <div class="row">
                    <div class="col-lg-6">
                        <div class="mb-4">
                            ...
                            <div class="row gx-2">
                                <input placeholder="$" type="text" class="form-control" id="regular_price" name="regular_price" value="{{ $product->regular_price }}">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="mb-4">
                            ...
                            <input placeholder="$" type="text" class="form-control" id="promo_price" name="promo_price" value="{{ $product->promo_price }}">
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="mb-4">
                            ...
                            <input type="text" placeholder="inch" class="form-control" id="width" name="width" value="{{ $product->width }}">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="mb-4">
                            <label for="height" class="form-label">Height</label>
                            <input type="text" placeholder="inch" class="form-control" id="height" name="height" value="{{ $product->height }}">
                        </div>
                    </div>
                </div>
                <div class="mb-4">
                    <label for="weight" class="form-label">Weight</label>
                    <input type="text" placeholder="gam" class="form-control" id="weight" name="weight" value="{{ $product->weight }}">
                </div>
                <div class="card mb-4">
                    <div class="card-header">
                        <h4>Media</h4>
                ...
                <input class="btn btn-light rounded font-sm mr-5 text-body hover-up" type="submit" value="Update">
            </form>
        </div>
    </div> <!-- card end// -->
</div>
