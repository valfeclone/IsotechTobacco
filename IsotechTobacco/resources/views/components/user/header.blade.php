                        ...
                        <ul>
                            <!-- <li>
                                ...
                                <ul class="language-dropdown">
                                    <li><a href="#"><img src="images/user/imgs/theme/flag-fr.png" alt="">Français</a></li>
                                    <li><a href="#"><img src="images/user/imgs/theme/flag-dt.png" alt="">Deutsch</a></li>
                                    <li><a href="#"><img src="images/user/imgs/theme/flag-ru.png" alt="">Pусский</a></li>
                                </ul>
                            </li> -->
        ...
        <div class="container">
            <div class="header-wrap header-space-between position-relative">
                <div class="logo logo-width-1">
                    <a href="index.html"><img src="{{ asset('images/user/imgs/theme/logo.svg') }}" alt="logo"></a>
                </div>
                                ...
                                <ul>
                                    <li>
                                        <div class="shopping-cart-img">
                                            <a href="shop-product-right.html"><img alt="Evara" src="{{ asset('images/user/imgs/shop/thumbnail-3.jpg') }}"></a>
                                        </div>
                                    ...
                                    <li>
                                        <div class="shopping-cart-img">
                                            <a href="shop-product-right.html"><img alt="Evara" src="{{ asset('images/user/imgs/shop/thumbnail-1.jpg') }}"></a>
                                        </div>
                                        <div class="shopping-cart-title">
