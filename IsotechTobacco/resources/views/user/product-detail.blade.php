                            ...
                            <div class="detail-info">
                                ...
                                <div class="product-detail-rating">
                                    <div class="pro-details-brand">
                                        <span> Category: <a href="shop-grid-right.html">{{ $items->category}}</a></span>
                                    </div>
                                ...
                                <div class="clearfix product-price-cover">
                                    <div class="product-price primary-color float-left">
                                        <ins><span class="text-brand">{{ $items->regular_price}}</span></ins>
                                ...
                                <ul class="product-meta font-xs color-grey mt-50">
                                    ...
                                    <li>Availability:<span class="in-stock text-success ml-5">{{ $items->stock}}</span></li>
                                </ul>
                            </div>
                            <!-- Detail Info -->
                        </div>
                        ...
                        <div class="col-lg-10 m-auto entry-main-content">
                            ...
                            <div class="social-icons single-share">
                                <ul class="text-grey-5 d-inline-block">
                                    ...
                                    {{ asset('images/user/imgs/theme/icons/icon-facebook.svg') }}
                                    ...
                                    <div class="col-lg-8">
                                        ...
                                        <div class="comment-list">
                                            <div class="single-comment justify-content-between d-flex">
                                                <div class="user justify-content-between d-flex">
                                                    <div class="thumb text-center">
                                                        <img src="{{ asset('images/user/imgs/page/avatar-6.jpg')}}" alt="">
                                            ...
                                            <div class="single-comment justify-content-between d-flex">
                                                <div class="user justify-content-between d-flex">
                                                    <div class="thumb text-center">
                                                        <img src="{{ asset('images/user/imgs/page/avatar-7.jpg')}}" alt="">
                                            ...
                                            <div class="single-comment justify-content-between d-flex">
                                                <div class="user justify-content-between d-flex">
                                                    <div class="thumb text-center">
                                                        <img src="{{ asset('images/user/imgs/page/avatar-8.jpg')}}" alt="">
...
"><i class="fi-rs-search"></i></a>
                    ...
                    <div class="banner-img banner-big wow fadeIn f-none animated mt-50">
                        <img class="border-radius-10" src="{{ asset('images/user/imgs/banner/banner-4.png') }}" alt="">
